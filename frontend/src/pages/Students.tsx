...
export const Students: React.FC<StudentsProps> = ({ onSelectStudent, onAddStudent }) => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-10">
      {/* Header Bar matching Reference UI Screen 2 */}
      <div className="bg-indigo-600 text-white px-4 py-3.5 flex items-center justify-between shadow-md">
        <h1 className="text-base font-bold tracking-tight">Students</h1>
          ...
          {students.map((student, idx) => {
            ...
            return (
              <div
                ...
                className="bg-white p-3.5 rounded-2xl border border-slate-100 shadow-xs hover:shadow-md transition-all cursor-pointer flex items-center justify-between group active:scale-[0.99]"
              >
